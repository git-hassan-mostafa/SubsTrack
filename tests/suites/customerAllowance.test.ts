...
describe('billing: lowering the limits', () => {
  it('TC-CD-01 allows a cut down to exactly the active counts', () => {
    expect(() =>
      billingService.validateDecrease(pair(40, 80), pair(60, 100), pair(40, 80)),
    ).not.toThrow();
  });

  it('TC-CD-02 refuses one below the active customer count', () => {
    try {
      billingService.validateDecrease(pair(39, 80), pair(60, 100), pair(40, 70));
  ...
  it('TC-CD-02b refuses one below the active service-line count', () => {
    try {
      billingService.validateDecrease(pair(40, 69), pair(60, 100), pair(40, 70));
      throw new Error('expected AllowanceFloorError');
    } catch (e) {
      expect(e).toBeInstanceOf(AllowanceFloorError);
  ...
  it('TC-CD-03 refuses a raise through the lowering door', () => {
    expect(() =>
      billingService.validateDecrease(pair(70, 100), pair(60, 100), pair(40, 70)),
    ).toThrow();
    expect(() =>
      billingService.validateDecrease(pair(60, 110), pair(60, 100), pair(40, 70)),
    ).toThrow();
  });

  it('TC-CD-03b refuses a save that moves neither limit', () => {
    expect(() =>
      billingService.validateDecrease(pair(60, 100), pair(60, 100), pair(40, 70)),
    ).toThrow();
  });

  it('TC-CD-03c lowering ONE limit alone is a real change', () => {
    expect(() =>
      billingService.validateDecrease(pair(60, 90), pair(60, 100), pair(40, 70)),
    ).not.toThrow();
  });

  it('TC-CD-04 refuses a fraction or a negative limit', () => {
    expect(() =>
      billingService.validateDecrease(pair(40.5, 80), pair(60, 100), pair(40, 70)),
    ).toThrow();
    expect(() =>
  ...
  it('TC-CD-05c the ACTIVE count outranks the floor when it is higher', () => {
    ...
    expect(() =>
      billingService.validateDecrease(pair(30, 80), pair(60, 100), pair(45, 70)),
  ...
  it('TC-CD-06 the floor outranks the raise check when both are wrong', () => {
    ...
    expect(() =>
      billingService.validateDecrease(pair(50, 90), pair(60, 100), pair(55, 70)),
    ).toThrow(AllowanceFloorError);
  });
