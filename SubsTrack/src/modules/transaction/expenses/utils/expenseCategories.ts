...
export const EXPENSE_CATEGORIES: {
  ...
  {
    code: "salaries",
    labelKey: "expenses.cat_salaries",
    icon: "people-outline",
  },
  {
    code: "utilities",
    labelKey: "expenses.cat_utilities",
    icon: "flash-outline",
  },
  ...
  {
    code: "maintenance",
    labelKey: "expenses.cat_maintenance",
    icon: "construct-outline",
  },
  {
    code: "equipment",
    labelKey: "expenses.cat_equipment",
    icon: "hardware-chip-outline",
  },
  {
    code: "internet",
    labelKey: "expenses.cat_internet",
    icon: "globe-outline",
  },
  {
    code: "taxes",
    labelKey: "expenses.cat_taxes",
    icon: "document-text-outline",
  },
  {
    code: "marketing",
    labelKey: "expenses.cat_marketing",
