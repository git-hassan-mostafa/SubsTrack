  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
            ...
            <View className="bg-white rounded-2xl mb-4 overflow-hidden border border-gray-100">
              ...
              <View className="px-5 pt-4 pb-4">
                ...
                <UsageBar
                  ...
                  limit={currentTier.maxCustomers}
                />
                <UsageBar
                  resource="users"
                  current={usage.users}
                  limit={currentTier.maxUsers}
                />
                <UsageBar
                  resource="plans"
                  current={usage.plans}
                  limit={currentTier.maxPlans}
                />
                <UsageBar
                  resource="branches"
                  current={usage.branches}
                  limit={currentTier.maxBranches}
                />
                <UsageBar
                  resource="currencies"
                  current={usage.currencies}
                  limit={currentTier.maxCurrencies}
                />
                <UsageBar
                  resource="products"
                  current={usage.products}
                  limit={currentTier.maxProducts}
                />
              </View>
            </View>
          ) : null}
      ...
      <ConfirmDialog
        ...
        message={t("subscription.downgrade_blocked_body", {
