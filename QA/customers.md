...
| 1.15a | Status pill — overdue past month | Active regular customer with current month paid (incl. a partial payment) BUT any earlier month past its grace window unpaid | Red "Unpaid" pill (an overdue past month overrides a paid current month) |
