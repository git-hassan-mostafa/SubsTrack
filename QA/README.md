...
| Sales | [sales.md](sales.md) | One-off sale recording, the row's **3-dot action menu**, **editing a recorded sale** (lines + stock ledger), walk-in (no customer), product snapshots, async customer picker, void, customer panel, dashboard revenue integration |
...
- [ ] [Sales](sales.md) passes: snapshots frozen at sale time, editing a sale re-cuts its lines + stock without double-counting, walk-in customer, void, customer panel, dashboard revenue included.
