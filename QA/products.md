...
| 6C.4b | The form scrolls back into view        | Scroll far down the history, then tap a row menu → Edit entry                                             | The body scrolls back to the TOP, so the on-hand card, the “Editing this entry” banner and the pre-filled fields are all on screen — without it the tap looks like it did nothing |
| 6C.4c | Switching edits scrolls again          | While editing row A, scroll down and tap Edit entry on row B                                              | The banner updates to row B and the body scrolls back to the top again                                                                                                            |
