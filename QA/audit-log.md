...
| #    | Scenario                     | Steps                                                                              | Expected result                                                                                                     |
| ---- | ---------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| 9.1  | A create names the record     | Add a customer → open the Audit Log                                                 | "*Name* added a new customer **John Doe**" — no record-type line, no subject pill, timestamp on its own muted line     |
| 9.2  | A month void names the month  | Void a paid month → open the Audit Log                                              | "*Name* voided the **March 2026** bill for **John Doe**" — the month, not `2026-03-01`, and not the bare word "Bill"  |
