...
3. Any active line with an unpaid past month → the red **"Overdue"** pill, whatever this month's state is. It never appears beside green "✓ Paid" (paid means the customer owes nothing); it _can_ appear beside "N/M plans paid" when the customer's other plans are clear.
