...
| 9b.5 | Dialogs close by their buttons | Open the upgrade prompt (hit a tier limit) or the location help modal; use its ✕ / Close / Cancel | The dialog closes; route unchanged; the screen stays clickable |
